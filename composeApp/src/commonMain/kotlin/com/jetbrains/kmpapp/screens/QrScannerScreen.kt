package com.jetbrains.kmpapp.screens.qrScanner
...
import com.jetbrains.kmpapp.platformName
import kotlinx.coroutines.launch
import network.chaintech.sdpcomposemultiplatform.sdp
import network.chaintech.sdpcomposemultiplatform.ssp
import org.jetbrains.compose.resources.painterResource
import ismartaudit.composeapp.generated.resources.Res
import ismartaudit.composeapp.generated.resources.ic_camera_switch
import ismartaudit.composeapp.generated.resources.ic_gallery_icon
import ismartaudit.composeapp.generated.resources.ic_rectangle
import ismartaudit.composeapp.generated.resources.ic_square_border
import qrscanner.CameraLens
import qrscanner.OverlayShape
import qrscanner.QrScanner

@Composable
fun QrScannerView(onBack: () -> Unit) {
            ...
            TopBar(
                ...
                onFlashToggle = {
                    if (cameraLens == CameraLens.Front) {
                        coroutineScope.launch {
                            snackbarHostState.showSnackbar("Flash not available on front camera")
                        }
                    } else {
                        flashlightOn = !flashlightOn
                    }
...
fun TopBar(
    ...
    Row(
        ...
        Text(
            if (flashlightOn) "Flash Off" else "Flash On",
            fontFamily = FontFamily.Serif,
            fontWeight = FontWeight.Bold,
            fontSize   = 18.ssp,
            color      = Color.White,
            modifier   = Modifier.clickable(onClick = onFlashToggle)
        )
    }
}
